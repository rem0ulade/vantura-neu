...
const copy = {
  en: {
    ...
    stackPortfolio: 'View the full technical portfolio',
  ...
  de: {
    ...
    stackPortfolio: 'Vollständiges technisches Portfolio ansehen',
