...
const copy = {
  en: {
    badge: 'External AI Officer · Vantura AI Lab',
    title: 'Your external AI Officer — from strategy to working systems.',
    lead: 'I help companies turn scattered AI experiments into a governed, prioritised AI programme — strategy, use cases, standards, enablement and hands-on implementation from one accountable owner.',
    primary: 'Discuss AI responsibility',
    visualTitle: 'AI as an operating model — not a tool rollout.',
    privateZone: 'Strategy',
    privateMain: 'Roadmap & priorities',
    privateSub: 'Use cases with business value',
    cloudZone: 'Governance',
    cloudMain: 'Standards & guardrails',
    cloudSub: 'Data, access & providers',
    approval: 'Critical actions',
    approvalValue: 'Owner + human approval',
    routing: 'Execution model',
    capabilitiesEyebrow: 'External AI Officer',
    capabilitiesTitle: 'One accountable owner across strategy, governance and delivery.',
    capabilities: [
      ['AI strategy & roadmap', 'Define where AI should create value, what comes first and how progress is measured.'],
      ['Use-case portfolio', 'Identify, prioritise and validate AI opportunities across teams instead of collecting disconnected experiments.'],
      ['Governance & guardrails', 'Set practical standards for data, tools, providers, approvals and responsible use.'],
      ['Enablement & implementation', 'Bring teams along, build working systems and turn the roadmap into adopted workflows.'],
    ],
    ...
    graceTitle: 'Grace — the product behind the advisory work.',
    ...
    cta: 'Need someone to own AI — not just demo it?',
    back: 'Back to studio',
  },
  de: {
    badge: 'Externer AI Officer / KI-Beauftragter',
    title: 'Externer AI Officer — von der Strategie bis zum produktiven KI-System.',
    lead: 'Ich helfe Unternehmen, aus einzelnen KI-Experimenten ein gesteuertes Programm zu machen — mit Strategie, Use-Case-Portfolio, Standards, Enablement und technischer Umsetzung aus einer Hand.',
    primary: 'KI-Verantwortung besprechen',
    visualTitle: 'KI als Unternehmensfunktion — nicht als Tool-Rollout.',
    privateZone: 'Strategie',
    privateMain: 'Roadmap & Prioritäten',
    privateSub: 'Use Cases mit Business-Nutzen',
    cloudZone: 'Governance',
    cloudMain: 'Standards & Leitplanken',
    cloudSub: 'Daten, Zugriffe & Anbieter',
    approval: 'Kritische Aktionen',
    approvalValue: 'Owner + Human Approval',
    routing: 'Operating Model',
    capabilitiesEyebrow: 'Externer AI Officer',
    capabilitiesTitle: 'Eine verantwortliche Schnittstelle zwischen Management, Teams und Technologie.',
    capabilities: [
      ['KI-Strategie & Roadmap', 'Festlegen, wo KI Wert schaffen soll, was zuerst kommt und wie Fortschritt messbar wird.'],
      ['Use-Case-Portfolio', 'KI-Chancen über Teams hinweg identifizieren, priorisieren und validieren statt isolierte Experimente zu sammeln.'],
      ['Governance & Leitplanken', 'Praktische Standards für Daten, Tools, Anbieter, Freigaben und verantwortungsvollen Einsatz etablieren.'],
      ['Enablement & Umsetzung', 'Teams befähigen, funktionierende Systeme bauen und die Roadmap in genutzte Workflows übersetzen.'],
    ],
    privacyEyebrow: 'Privacy-first AI',
    ...
    graceTitle: 'Grace — das Produkt hinter der Beratung.',
    ...
    cta: 'Sie brauchen jemanden, der KI wirklich verantwortet — nicht nur demonstriert?',
