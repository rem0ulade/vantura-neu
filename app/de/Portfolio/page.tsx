...
const projects = [
  ...
  },
  {
    ...
    description: 'Geschäftskritische Reporting-, Forecasting-, Kalkulations- und Entscheidungsunterstützungstools aus deutschen und internationalen Media-Umfeldern, darunter Publicis Media. Kundendaten, Oberflächen und Implementierungsdetails bleiben vertraulich; Verantwortungsbereiche und technischer Umfang können dennoch besprochen werden.',
